...
const val telegramMessageForPattern = "%s приближается к граничной линии паттерна"
...
const val candlesPerWorkingDayForStock = 16
const val candlesPerDayForCrypto = 24